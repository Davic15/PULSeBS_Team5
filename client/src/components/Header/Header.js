        ...
        <AuthContext.Consumer>
            {(context) => <> 
                <nav className="navbar">
                    ...
                    {context.authUser && (/*context.authUser.Type === "student" ||*/ context.authUser.Type === "teacher") && 
                        <Link to="/lectures"><Button variant="primary">Lectures</Button> </Link>}
                    {context.authUser && (context.authUser.Type === "booking-manager" || context.authUser.Type === "teacher" || context.authUser.Type === "officer") &&
                        <Link to="/courses"><Button variant="primary">Courses</Button></Link>}
                    {context.authUser && (context.authUser.Type === "booking-manager") && 
                        <Link to="/reports"><Button variant="primary">Reports</Button></Link>}
                    {context.authUser && (context.authUser.Type === "officer") && 
                        <Link to="/restrictions"><Button variant="primary">Restrictions</Button></Link>}
                    {context.authUser && (context.authUser.Type === "officer") && 
